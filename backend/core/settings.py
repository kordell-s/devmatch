...
SECRET_KEY = "django-insecure-zfv-i7$y65&g=zi%=ri&2q*(a%_oq)j%1eybtpcnenxp718#%u"
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = 'developers-list'  # Redirect to developers list after logout
